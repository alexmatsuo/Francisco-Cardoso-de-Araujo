    ...
    <main className="works-container">
      ...
      <div className="mb-12">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 mb-8">
          <div>
            ...
            <p className="text-[#D3CEAD]/70">Compositions for duos and trios</p>
          </div>
                ...
                const content = (
                  <div className="group bg-white/5 backdrop-blur-sm border border-white/10 p-2 hover:bg-white/10 transition-all duration-300 hover:border-[#D3CEAD]/30 aspect-square flex flex-col">
                    ...
                    <div className="flex-1 flex flex-col justify-between">
                      ...
                      {/* Duos & Trios Badge */}
                      <div className="mt-1">
                        <div className="text-xs px-1 py-0.5 bg-green-500/20 text-green-400 border-green-500/30 truncate">
                          Duos
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="group flex items-center gap-4 p-4 bg-white/5 backdrop-blur-sm border border-white/10 hover:bg-white/10 transition-all duration-300 hover:border-[#D3CEAD]/30">
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-3 mb-1">
                        ...
                        <div className="px-2 py-1 text-xs border bg-green-500/20 text-green-400 border-green-500/30">
                          Duos & Trios
                        </div>
                      </div>
      ...
      <div className="mt-16 pt-8 border-t border-white/10">
        <div className="text-center">
          ...
          <div className="text-sm text-[#D3CEAD]/70">Duos & Trios Works</div>
        </div>
      </div>
    </main>
  );

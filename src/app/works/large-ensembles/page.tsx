...
export default function LargeEnsemblesWorks() {
    ...
    <main className="works-container">
      ...
      <div className="mb-12">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 mb-8">
          <div>
            <h1 className="text-4xl font-bold mb-2 text-[#D3CEAD]">Large Ensembles</h1>
            <p className="text-[#D3CEAD]/70">Compositions for large ensembles</p>
          </div>
                ...
                const content = (
                  <div className="group bg-white/5 backdrop-blur-sm border border-white/10 p-2 hover:bg-white/10 transition-all duration-300 hover:border-[#D3CEAD]/30 aspect-square flex flex-col">
                    ...
                    <div className="flex-1 flex flex-col justify-between">
                      ...
                      {/* Large Ensembles Badge */}
                      <div className="mt-1">
                        <div className="text-xs px-1 py-0.5 bg-orange-500/20 text-orange-400 border-orange-500/30 truncate">
                          Large
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="group flex items-center gap-4 p-4 bg-white/5 backdrop-blur-sm border border-white/10 hover:bg-white/10 transition-all duration-300 hover:border-[#D3CEAD]/30">
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-3 mb-1">
                        ...
                        <div className="px-2 py-1 text-xs border bg-orange-500/20 text-orange-400 border-orange-500/30">
                          Large Ensembles
                        </div>
                      </div>
      ...
      <div className="mt-16 pt-8 border-t border-white/10">
        <div className="text-center">
          ...
          <div className="text-sm text-[#D3CEAD]/70">Large Ensembles Works</div>
        </div>
      </div>
    </main>
  );
